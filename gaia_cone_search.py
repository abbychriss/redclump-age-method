...
#coord = SkyCoord(ra=117.465, dec=-17.225, unit=(u.degree, u.degree), frame='icrs') # Ruprecht 37 (0.1radius)
coord = SkyCoord(ra=359.3340, dec=+56.7260,unit=(u.degree, u.degree), frame='icrs') # NGC 7789
...
outputfilename = "ngc7789_cone.csv"
